...
public class ContatoRepository {
    ...
    public void update(Contato contato) throws Exception {
        ...
        String query = "UPDATE contato SET nome=?, email=?, telefone=?, mensagem=? WHERE id_contato=?";
    ...
    public List<Contato> findAll() throws Exception {
        ...
        String query = "SELECT * FROM contato ORDER BY id_contato DESC";
        ...
        while (resultSet.next()) {
            ...
            contato.setRespondido(resultSet.getBoolean("respondido")); // Lendo o status
    ...
    public Contato findById(Integer idContato) throws Exception {
        ...
        String query = "SELECT * FROM contato WHERE id_contato=?";
    ...
    public void atualizarStatus(Integer idContato, boolean status) throws Exception {
        
        Connection connection = ConnectionFactory.getConnection();
        
        String query = "UPDATE contato SET respondido=? WHERE id_contato=?";
        
        PreparedStatement statement = connection.prepareStatement(query);
        
        statement.setBoolean(1, status);
        statement.setInt(2, idContato);
